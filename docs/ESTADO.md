...
- **Testes (`npm test`, 341)** com a tabela de §5.3 inteira e o teste obrigatório da sessão; **`scripts/e2e/sessao-8.cjs`** com 82 verificações nos dois tamanhos, e os roteiros das Sessões 6 (52) e 7 (76) verdes como regressão; capturas em `docs/capturas/sessao-8/`.
