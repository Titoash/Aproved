/** Fundo da janela fora do palco: navy com gradiente radial e estrelas. O palco em si é desenhado pela TabuleiroScene. */
...
export class BackgroundScene extends Phaser.Scene {
  ...
  create() {
    ...
    // O tabuleiro roda em paralelo, por cima do fundo.
    if (!this.scene.isActive(TabuleiroScene.KEY)) this.scene.launch(TabuleiroScene.KEY);
